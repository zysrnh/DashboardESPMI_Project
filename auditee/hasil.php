...
$check = mysqli_query($koneksi, "SELECT ja.*, ua.nama_unit, ua.kode_unit, ua.pimpinan, 
                                  ...
                                  WHERE ja.id=$jadwal_id AND ja.auditee_id=$user_id");
                        ...
                        <div class="accordion" id="accordionDetail">
                            ...
                            while ($p = mysqli_fetch_assoc($penilaian)): 
                                ...
                                if ($current_standar != $p['standar_kode']):
                                    if ($current_standar != '') echo '</div></div></div></div>'; // Close previous
                                    $current_standar = $p['standar_kode'];
                                    $accordion_no++;
                            ?>
                            <div class="accordion-item">
                                <h2 class="accordion-header">
                                    <button class="accordion-button <?php echo $accordion_no > 1 ? 'collapsed' : ''; ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $accordion_no; ?>">
                                        <strong><?php echo $p['standar_kode']; ?> - <?php echo $p['nama_standar']; ?></strong>
                                    </button>
                                </h2>
                                <div id="collapse<?php echo $accordion_no; ?>" class="accordion-collapse collapse <?php echo $accordion_no == 1 ? 'show' : ''; ?>" data-bs-parent="#accordionDetail">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p class="mb-0">
                            ...
                            <em>Untuk informasi lebih detail, silakan lihat breakdown penilaian per standar dan indikator di atas.</em>
                        </p>
                    </div>
                </div>
